class Media {
    constructor(image, title, author, genre, publisher, short, rating) {
        this.image = image;
        this.title = title;
        this.author = author;
        this.genre = genre;
...
for (var i = 0; i < books.length; i++) {
    allBooks.innerHTML +=
        ...
        '</p>' + '</p>' + '</p>' +
        '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">' + "More Information" + '</button>' +
